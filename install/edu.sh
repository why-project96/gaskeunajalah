...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/why-project96/gaskeunajalah/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/why-project96/gaskeunajalah/main/edu-op.py
